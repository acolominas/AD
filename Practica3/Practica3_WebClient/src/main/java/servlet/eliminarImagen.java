    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (id == null) {
                ...
                ws.Image img = SOAPConnection.searchById(Integer.valueOf(id));

                if(img.getCreator().equals(user)) {
                    
                    if(SOAPConnection.deleteImage(Integer.valueOf(id))) {                    
                        out.println("Deleted the file: " + "Images/" + img.getFilename());
